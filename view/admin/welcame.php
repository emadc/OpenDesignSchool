		...
		<div class="col-12">
			<div class="card mb-3">
				<div class="card-header">
					...
					<span class="nav-link-text">Bannière</span>
				</div>
				<div>
					<form class="form_admin" name="welcame" action="<?php echo htmlspecialchars(HOST.'page_upload');?>" method="post" enctype="multipart/form-data">
						<div>
							...
							<input type="hidden" name="values[item_alias]" value="welcame">
							...
							<textarea id="text" name='values[text]' class='form-control' style='height: 200px;margin-bottom: 10px;' placeholder="Presentation"><?php echo $page->getText();?></textarea>
						</div>
						<div>
